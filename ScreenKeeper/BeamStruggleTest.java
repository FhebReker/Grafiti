...
public class BeamStruggleTest extends JFrame {
    ...
    private Rectangle beam1 = new Rectangle(cannon1X + 100, 340, 50, 20); // Beam 1 rectangle
    ...
    private Rectangle beam2 = new Rectangle(cannon2X - 50, 340, 50, 20); // Beam 2 rectangle
