...
public class AnimationMain {
	...
	//so it's really easy to find and change when needed
	...
	*/
	...
	if (ball.yspeed > 0 ) { //the ball must be moving downwards,
	not upwards
	ball.yspeed *=‐1;
	}
	}
	...
	//now you need to figure out how to to the same for the right side of
	the screen (I did the easy one!)
	//...
	}
	void drawGraphics() {
